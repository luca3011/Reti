    ...
    public static void main(String[] args) {
        ...
        try {//controllo parametri
            if (args.length == 1)
                ...
                port = PORT;
            else {System.out.println("rinserire porta");}
        ...
        try {
            while(true) {
                ...
                }catch(SocketTimeoutException e) {System.out.println("Scattato il timeout");e.printStackTrace(); continue;}
                catch(Exception e) {System.out.println("Errore nell'accettazione della socket");e.printStackTrace();continue;}
